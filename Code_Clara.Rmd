...
```{r}
g <- ggplot(df, aes(df.area3HLabelled))
g + geom_bar(aes(fill=df.studioLabelled), width = 0.5) + labs(title="Histogram on Education in Italy",subtitle="Educational attainment in the different Geographical Areas", x= "Geographical Area", y= "count", fill="Educational Attainment") + coord_flip()

#trying to figure out how to make the bars 100%
```
------------------------------------------------------------------------
