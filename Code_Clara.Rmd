...
The second variable we will use for our analysis is the geographic area from which the surveyed population comes from. More specifically, the variable divides the population in three parts: North, Centre and South plus Islands. 
...
```{r fig.asp = 0.3, fig.width = 8, echo=FALSE}
...
g + geom_bar(position="fill", width = 0.5) + labs(title="Histogram on Education in Italy",subtitle="Educational attainment in the different Geographical Areas", x= "Geographical Area", y= "Percentage", fill="Educational Attainment") + geom_text(data=percentData, aes(y=n,label=ratio), position=position_fill(vjust=0.5),colour="white") + coord_flip()
...
g + geom_bar(position="fill", width = 0.9) + labs(title="Histogram on Education in Italy",subtitle="Educational attainment in the different Geographical Areas", x= "Geographical Area", y= "Percentage", fill="Educational Attainment") + geom_text(data=percentData, aes(y=n,label=ratio), position=position_fill(vjust=0.5),colour="white") + coord_flip()
```
