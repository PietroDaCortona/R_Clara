...
g + geom_bar(aes(fill=df.studioLabelled), width = 0.5) + labs(title="Histogram on Absolute Educational Attainment in Italy",subtitle="by Geographical Areas", x= "Geographical Area", y= "count", fill="Educational Attainment") + coord_flip()
...
g + geom_bar(position="fill", width = 0.5) + labs(title="Histogram on Relative Educational Attainment in Italy",subtitle="by Geographical Areas", x= "Geographical Area", y= "Percentage", fill="Educational Attainment") + geom_text(data=percentData, aes(y=n,label=ratio), position=position_fill(vjust=0.5),colour="white") + coord_flip()
...
```{r fig.asp = 0.5, fig.width = 5.5, echo=FALSE}
...
g + geom_bar(position="fill", width = 0.7) + labs(title="Histogram on Relative Number of Graduates in Italy",subtitle="by Geographical Areas", x= "Geographical Area", y= "Percentage", fill="Educational Attainment") + geom_text(data=percentData, aes(y=n,label=ratio), position=position_fill(vjust=0.5),colour="white") + coord_flip()
...
g + geom_bar(position="fill", width = 0.9) + labs(title="Histogram on Relative Educational Attainment in Italy",subtitle="By Region", x= "Geographical Area", y= "Percentage", fill="Educational Attainment") + geom_text(data=percentData, aes(y=n,label=ratio), position=position_fill(vjust=0.5),colour="white") + coord_flip()
```
...
ggplot(r_inc_f,aes(x=long,y=lat,group=group))+
  ...
  geom_path(colour='white',linewidth=1e-3) +scale_fill_gradient(low = 'yellow', high = 'darkorange') + coord_fixed() + labs(title="Median income in Italy of Graduates",subtitle="Income distribution in the different Italian regions of graduates", x= "Longitude", y= "Latitude")
...
ggplot(r_inc_f,aes(x=long,y=lat,group=group))+
  ...
  geom_path(colour='white',linewidth=1e-3) +scale_fill_gradient(low = 'yellow', high = 'darkorange') + coord_fixed() + labs(title="Percentage of Graduates in Italy",subtitle="Distribution of graduates in the different Italian regions", x= "Longitude", y= "Latitude", fill= "Percentage ")
