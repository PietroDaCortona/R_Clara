...
reg_income2$Income<-as.integer(reg_income2$Income)
...
ggplot(r_inc_f,aes(x=long,y=lat,group=group))+
  ...
  geom_path(colour='white',size=1e-3) +scale_fill_gradient(low = 'yellow', high = 'darkorange') + coord_fixed() + labs(title="Median income in Italy of Graduates",subtitle="Income distribution in the different Italian regions of graduates", x= "Longitude", y= "Latitude")
...
ggplot(r_inc_f,aes(x=long,y=lat,group=group))+
  ...
  geom_path(colour='white',size=1e-3) +scale_fill_gradient(low = 'yellow', high = 'darkorange') + coord_fixed() + labs(title="Percentage of Graduates in Italy",subtitle="Distribution of graduates in the different Italian regions", x= "Longitude", y= "Latitude", fill= "Percentage ")
