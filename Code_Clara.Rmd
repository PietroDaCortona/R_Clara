...
ggplot(r_inc_f,aes(x=long,y=lat,group=group))+
  ...
  geom_path(colour='white',linewidth=1e-3) +scale_fill_gradient(low = 'yellow', high = 'darkorange') + coord_fixed() + labs(title="Median income in Italy of Graduates",subtitle="Income distribution in the different Italian regions of graduates",fill= "Median Income ") + theme_classic()  + theme(axis.ticks.x = element_blank(),
